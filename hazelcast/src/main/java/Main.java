...
public class Main {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        IMap<Long, Klient> klientMap = instance.getMap("klient");
        IMap<Long, Podroz> podrozMap = instance.getMap("podroz");
            ...
            switch(s){
                ...
                case 3:
                    ...
                    if(l==1){
                        ...
                        Klient klient = klientMap.remove(klientID);
                    ...
                    if(l==2){
                        ...
                        Podroz podroz = podrozMap.remove(podrozID);
                ...
                case 4:
                    int k = wyborTabeli();
                    if(k==1){
                        for (Long key: klientMap.keySet()) {
                            System.out.println(key + ", " + klientMap.get(key) + ", ");
                        }
                        break;
                    }
                    if(k==2){
                        for (Long key: podrozMap.keySet()) {
                            System.out.println(key + ", " + podrozMap.get(key) + ", ");
                        }
                        break;
                    }
                    break;
